 ...
 */
@Entity public class MateriasEstudiantesDAO extends BaseHibernateDAOAlert {
	...
	public MateriasEstudiantes findById(java.lang.String id) {
	...
	public List findByExample(MateriasEstudiantes instance) {
