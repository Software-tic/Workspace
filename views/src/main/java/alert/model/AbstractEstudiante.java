...
public abstract class AbstractEstudiante implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractEstudiante() {
	}

	/** minimal constructor */
	public AbstractEstudiante(Long id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractEstudiante(Long id, String apellidos, String celular,
