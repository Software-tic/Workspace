...
public abstract class AbstractMaterias implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractMaterias() {
	}

	/** minimal constructor */
	public AbstractMaterias(String id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractMaterias(String id, String fechaFin, String fechaInicio,
