...
public abstract class AbstractDecanoFacultad implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractDecanoFacultad() {
	}

	/** minimal constructor */
	public AbstractDecanoFacultad(Long idDecano) {
		this.idDecano = idDecano;
	}

	/** full constructor */
	public AbstractDecanoFacultad(Long idDecano, Long idFacultad, String mail,
			String nomDecano) {
		this.idDecano = idDecano;
