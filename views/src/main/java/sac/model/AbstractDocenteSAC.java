...
public abstract class AbstractDocenteSAC implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractDocenteSAC() {
	}

	/** minimal constructor */
	public AbstractDocenteSAC(Long id) {
		this.id = id;
	}

	/** full constructor */
	public AbstractDocenteSAC(Long id, String apellidos, String celular,
			String codigo, String correoAlternativo,
